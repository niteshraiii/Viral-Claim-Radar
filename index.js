...
async function uploadDocument() {
    ...
    try {
        ...
        fileMeta.textContent = `${data.file_name || selectedFile.name} indexed successfully with ${data.chunks} chunks.`;
...
async function askQuestion() {
    ...
    try {
        ...
        setStatus(`Answered using ${data.source_count} source chunk(s).`);
    } catch (error) {
